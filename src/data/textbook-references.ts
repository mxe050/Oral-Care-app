...
export const TEXTBOOK_REFERENCES: Record<string, TextbookReference> = {
  ...
  uchida_shinkei: {
    ...
    publisher: '三輪書店',
    year: 2019,
    shortLabel: '内田『姿勢を意識した神経疾患患者の食べられるポジショニング』',
  },
  koyama_kuchi: {
    id: 'koyama_kuchi',
    authors: '小山 珠美(編)',
  ...
  koyama_jissen1: {
    ...
    year: 2012,
    shortLabel: '小山『実践で身につく摂食・嚥下障害へのアプローチ』(Part 1)',
  },
  koyama_jissen2: {
    id: 'koyama_jissen2',
    authors: '小山 珠美(編)',
    ...
    publisher: '学研メディカル秀潤社',
    year: 2012,
    shortLabel: '小山『実践で身につく摂食・嚥下障害へのアプローチ』(Part 2)',
  },
  yamada_ninchisho: {
    id: 'yamada_ninchisho',
